    ...
    switch (lang) {
      case "EN":
        return {
          ...
          supportLinks: [
            { label: "Size Guide", href: sitePaths.sizeGuide.EN },
            { label: "Shipping & Returns", href: sitePaths.shippingReturns.EN },
            { label: "Contact", href: sitePaths.contact.EN },
      ...
      case "AR":
        return {
          ...
          supportLinks: [
            { label: "دليل الأحجام", href: sitePaths.sizeGuide.AR },
            { label: "الشحن والعودة", href: sitePaths.shippingReturns.AR },
            { label: "اتصل بنا", href: sitePaths.contact.AR },
