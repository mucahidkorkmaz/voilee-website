...
const t = {
  TR: {
    ...
    kvkk: {
      ...
      marketingDesc: "Kampanya, koleksiyon ve özel teklifler hakkında e-posta almak istiyorum.",
  ...
  EN: {
    ...
    kvkk: {
      ...
      marketingDesc: "I want to receive emails about campaigns, collections and special offers.",
  ...
  AR: {
    ...
    kvkk: {
      ...
      marketingDesc: "أريد تلقّي رسائل إلكترونية حول الحملات والمجموعات والعروض الخاصة.",
      analytics: "التخصيص",
